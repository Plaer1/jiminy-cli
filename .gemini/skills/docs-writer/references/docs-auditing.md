...
This guide outlines the process for auditing the Jiminy CLI documentation for
...
the Jiminy CLI documentation style guide, and reflects the current state of the
codebase.
    ...
    - **Review against Style Guide:**
      ...
      - **Formatting and Syntax Violations:**
        ...
        - **Casing:** Identify incorrect casing for headings, titles, or named
          entities (e.g., product names like `Jiminy CLI`).
