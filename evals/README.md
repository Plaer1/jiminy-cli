...
The
[Evals: Nightly](https://github.com/Plaer1/jiminy-cli/actions/workflows/evals-nightly.yml)
...
- **CI Evals**: Included in the
  [E2E (Chained)](https://github.com/Plaer1/jiminy-cli/actions/workflows/chained_e2e.yml)
