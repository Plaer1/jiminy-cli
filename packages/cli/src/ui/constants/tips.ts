...
export const INFORMATIVE_TIPS = [
  ...
  'Choose a specific Jiminy model for conversations (/settings)…',
  ...
  'Toggle respect for .jiminyignore files in context (/settings)…',
  ...
  'Show Jiminy CLI status in the terminal window title (/settings)…',
  ...
  'Choose your Jiminy model with /model',
