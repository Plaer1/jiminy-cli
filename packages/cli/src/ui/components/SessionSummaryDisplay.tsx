...
import { escapeShellArg, getShellConfiguration } from '@plaer1/jiminy-cli-core';
...
export const SessionSummaryDisplay: React.FC<SessionSummaryDisplayProps> = ({
  ...
  let footer = `To resume this session: jiminy --resume ${escapedSessionId}`;
  ...
  return (
    <StatsDisplay
      title="Jiminy needs some rest. Goodnight!"
      duration={duration}
      footer={footer}
    />
  );
