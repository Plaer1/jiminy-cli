...
describe('JiminyPrivacyNotice', () => {
  ...
  it('renders correctly', async () => {
    const { lastFrame, unmount } = await render(
      <JiminyPrivacyNotice onExit={onExit} />,
    );

    expect(lastFrame()).toContain('Jiminy API Key Notice');
    expect(lastFrame()).toContain('By using the Jiminy API');
