...
import { debugLogger, isGitRepository } from '@plaer1/jiminy-cli-core';
...
export function getInstallationInfo(
  ...
  try {
    ...
    if (
      ...
      const updateCommand = 'pnpm add -g @plaer1/jiminy-cli@latest';
      return {
    ...
    if (realPath.includes('/.yarn/global')) {
      const updateCommand = 'yarn global add @plaer1/jiminy-cli@latest';
      return {
    ...
    if (realPath.includes('/.bun/install/global')) {
      const updateCommand = 'bun add -g @plaer1/jiminy-cli@latest';
      return {
    ...
    // Assume global npm
    const updateCommand = 'npm install -g @plaer1/jiminy-cli@latest';
    return {
