...
Jiminy CLI extension. It demonstrates how to expose tools and prompts to the
Jiminy CLI.
...
- `jiminy-extension.json`: The configuration file that tells Jiminy CLI how to
  use this extension.
...
This example is typically used by `jiminy extensions new`.
