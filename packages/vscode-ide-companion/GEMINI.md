# Jiminy CLI VS Code Companion (`jiminy-cli-vscode-ide-companion`)

VS Code extension that pairs with Jiminy CLI, providing direct IDE workspace
...
- Run tests: `npm test -w jiminy-cli-vscode-ide-companion`
