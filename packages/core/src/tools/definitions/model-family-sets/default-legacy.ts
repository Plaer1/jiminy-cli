...
`,
  ...
  google_web_search: {
    ...
    description:
      'Performs a web search using Google Search (via the Jiminy API) and returns the results. This tool is useful for finding information on the internet based on a query.',
    parametersJsonSchema: {
      type: 'object',
      properties: {
        [WEB_SEARCH_PARAM_QUERY]: {
