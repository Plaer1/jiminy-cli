...
describe('memory commands', () => {
  ...
  beforeEach(() => {
    mockConfig = {
      getUserMemory: vi.fn(),
      getJiminyMdFileCount: vi.fn(),
      getJiminyMdFilePaths: vi.fn(),
  ...
  describe('showMemory', () => {
    it('should show memory content if it exists', () => {
      ...
      vi.mocked(mockConfig.getJiminyMdFileCount).mockReturnValue(1);
    ...
    it('should show a message if memory is empty', () => {
      vi.mocked(mockConfig.getUserMemory).mockReturnValue('');
      vi.mocked(mockConfig.getJiminyMdFileCount).mockReturnValue(0);
  ...
  describe('listMemoryFiles', () => {
    it('should list the memory files in use', () => {
      ...
      vi.mocked(mockConfig.getJiminyMdFilePaths).mockReturnValue(filePaths);
    ...
    it('should show a message if no memory files are in use', () => {
      vi.mocked(mockConfig.getJiminyMdFilePaths).mockReturnValue([]);
