...
/**
 * Decoupled LLM request format - stable across Jiminy CLI versions
 */
...
/**
 * Decoupled LLM response format - stable across Jiminy CLI versions
 */
...
/**
 * Decoupled tool configuration - stable across Jiminy CLI versions
 */
