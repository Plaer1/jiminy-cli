# RFC: Jiminy CLI A2A Development-Tool Extension

## 1. Introduction

### 1.1 Overview

To standardize client integrations with the Jiminy CLI agent, this document
...
required for rich, interactive workflows with the Jiminy CLI agent.

### 1.2 Motivation

Recent work integrating Jiminy CLI with clients like Zed and Jiminy Code
...
- **Ecosystem Alignment**: Aligns Jiminy CLI with a growing industry standard,
...
workflows between a client and the Jiminy CLI agent. It consists of a
...
// Configuration settings for the Jiminy CLI agent.
...
This method allows the client to discover slash commands supported by Jiminy
