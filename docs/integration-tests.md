...
the Jiminy CLI. They execute the built binary in a controlled environment and
...
any information about yourself or your system that jiminy may have included in
these responses.
...
... output from the jiminy command ...
...
Jiminy CLI is tested across each:
