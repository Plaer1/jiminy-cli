...
This document provides the technical specification for Jiminy CLI hooks,
...
Jiminy CLI uses these structures to ensure hooks don't break across SDK updates.
