...
using Jiminy CLI to enhance your workflow right from your terminal.
...
[Jiminy CLI Installation](./installation.mdx).
...
[Jiminy CLI Authentication Setup](./authentication.mdx).
