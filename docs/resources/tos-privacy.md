...
AI services directly from your command-line interface. Jiminy CLI software is
licensed under the
...
Directly accessing the services powering Jiminy CLI (for example, the Gemini
Code Assist service) using third-party software, tools, or services (for
example, using OpenClaw with Jiminy CLI OAuth) is a violation of applicable
...
> pricing details that apply to your usage of Jiminy CLI.
...
- Terms of Service: Your use of Jiminy CLI is governed by the
