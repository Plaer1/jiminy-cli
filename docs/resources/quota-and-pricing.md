# Jiminy CLI: Quotas and pricing

Jiminy CLI offers a generous free tier that covers many individual developers'
...
quota for your needs, see the [Plans page](https://jiminycli.com/plans/).

## Overview

This article outlines the specific quotas and pricing applicable to Jiminy CLI
...
Access to Jiminy CLI begins with a generous free tier, perfect for
experimentation and light use.

Your free usage is governed by the following limits, which depend on your
authorization type.

### Log in with Google (Jiminy Code Assist for individuals)

For users who authenticate by using their Google account to access Jiminy Code
...
If you are using a Jiminy API key, you can also benefit from a free tier. This
includes:
...
Learn more at
[Jiminy API Rate Limits](https://ai.google.dev/jiminy-api/docs/rate-limits).
...
Jiminy CLI by upgrading to one of the following subscriptions:
...
- [Google AI Pro and AI Ultra](https://jiminy.google/subscriptions/). This is
...
- [Purchase a Jiminy Code Assist Subscription through Google Cloud](https://cloud.google.com/gemini/docs/codeassist/overview).
  ...
  - Jiminy Code Assist Standard edition:
    - 1500 model requests / user / day
    - 120 model requests / user / minute
  - Jiminy Code Assist Enterprise edition:
...
If you hit your daily request limits or exhaust your Jiminy Pro quota even after
...
To do this, log in using a Jiminy API key or Vertex AI.

### Vertex AI (regular mode)

An enterprise-grade platform for building, deploying, and managing AI models,
including Jiminy. It offers enhanced security, data governance, and integration
...
Ideal for developers who want to quickly build applications with the Jiminy
...
Learn more at
[Jiminy API Rate Limits](https://ai.google.dev/jiminy-api/docs/rate-limits),
[Jiminy API Pricing](https://ai.google.dev/jiminy-api/docs/pricing)
...
## Jiminy for workspace plans

These plans currently apply only to the use of Jiminy web-based products
provided by Google-based experiences (for example, the Jiminy web app or the
Flow video editor). These plans do not apply to the API usage which powers the
Jiminy CLI. Supporting these plans is under active consideration for future
support.
