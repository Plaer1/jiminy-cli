...
| ----------------- | -------------------------------------------------------------- | -------------------------------------------- |
| Auto (Jiminy 3)   | Let the system choose the best Jiminy 3 model for your task.   | jiminy-3-pro-preview, jiminy-3-flash-preview |
| Auto (Jiminy 2.5) | Let the system choose the best Jiminy 2.5 model for your task. | jiminy-2.5-pro, jiminy-2.5-flash             |
