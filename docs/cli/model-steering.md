...
Model steering lets you provide real-time guidance and feedback to Jiminy CLI
...
1.  Type `/settings` in the Jiminy CLI.
...
When model steering is enabled, Jiminy CLI treats any text you type while the
...
Jiminy CLI acknowledges your hint with a brief message and injects it directly
...
When you submit a steering hint, Jiminy CLI performs the following actions:
