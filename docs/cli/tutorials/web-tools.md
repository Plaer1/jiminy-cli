...
Jiminy uses the `google_web_search` tool to find relevant pages and synthesizes
...
Jiminy will retrieve the page content (stripping away ads and navigation) and
