...
This guide details the Model Configuration system within the Jiminy CLI.
...
| :---------------------- | :------- | :----------------------------------------------------------------- |
| `model`                 | `string` | The identifier of the model to be called (e.g., `jiminy-2.5-pro`). |
  ...
  "overrides": [
    {
      ...
      "modelConfig": {
        "model": "jiminy-2.5-pro-experimental-001"
      }
    }
  ]
}
