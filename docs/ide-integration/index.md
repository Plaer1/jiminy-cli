...
- **Native diffing:** When Jiminy suggests code modifications, you can view the
...
When you ask Jiminy to modify a file, it can open a diff view directly in your
editor.
...
If you are using Jiminy CLI within a sandbox, please be aware of the following:
...
- **Message:**
  `No installer is available for IDE. Please install the Jiminy CLI Companion extension manually from the marketplace.`
