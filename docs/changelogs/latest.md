...
- fix(patch): cherry-pick a4e98c0 to release/v0.39.0-preview.0-pr-25138 to patch
  ...
  @jiminy-cli-robot in
  [#25766](https://github.com/Plaer1/jiminy-cli/pull/25766)
- fix(patch): cherry-pick d6f88f8 to release/v0.39.0-preview.1-pr-25670 to patch
  ...
  @jiminy-cli-robot in
  [#25776](https://github.com/Plaer1/jiminy-cli/pull/25776)

**Full Changelog**:
https://github.com/Plaer1/jiminy-cli/compare/v0.38.2...v0.39.0
