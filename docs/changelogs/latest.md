...
- fix(patch): cherry-pick 8432bce to release/v0.34.0-preview.1-pr-22069 to patch
  ...
  @jiminy-cli-robot in
  [#22205](https://github.com/google-jiminy/jiminy-cli/pull/22205)
- fix(patch): cherry-pick 24adacd to release/v0.34.0-preview.2-pr-22332 to patch
  ...
  @jiminy-cli-robot in
  [#22391](https://github.com/google-jiminy/jiminy-cli/pull/22391)
- fix(patch): cherry-pick 48130eb to release/v0.34.0-preview.3-pr-22665 to patch
  ...
  @jiminy-cli-robot in
  [#22719](https://github.com/google-jiminy/jiminy-cli/pull/22719)

**Full Changelog**:
https://github.com/google-jiminy/jiminy-cli/compare/v0.33.2...v0.34.0
