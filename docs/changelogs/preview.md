...
- **MCP Resource Tools:** New core tools added to list and read MCP (Model
  ...
  MCP servers.
- **Local Model Setup:** Introduced a streamlined `jiminy gemma` command for
