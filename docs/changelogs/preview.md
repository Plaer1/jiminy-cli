...
- fix(patch): cherry-pick b2d6dc4 to release/v0.35.0-preview.4-pr-23546
  ...
  [#23585](https://github.com/google-jiminy/jiminy-cli/pull/23585)
- fix(patch): cherry-pick daf3691 to release/v0.35.0-preview.2-pr-23558 to patch
  ...
  @jiminy-cli-robot in
  [#23565](https://github.com/google-jiminy/jiminy-cli/pull/23565)
...
- refactor(core): introduce InjectionService with source-aware injection and
  ...
  [#22544](https://github.com/google-jiminy/jiminy-cli/pull/22544)
- Linux sandbox bubblewrap by @DavidAPierce in
  [#22680](https://github.com/google-jiminy/jiminy-cli/pull/22680)
- feat(core): increase thought signature retry resilience by @bdmorgan in
  [#22202](https://github.com/google-jiminy/jiminy-cli/pull/22202)
- feat(core): implement Stage 2 security and consistency improvements for
  web_fetch by @aishaneeshah in
  [#22217](https://github.com/google-jiminy/jiminy-cli/pull/22217)
- refactor(core): replace positional execute params with ExecuteOptions bag by
  @adamfweidman in
  [#22674](https://github.com/google-jiminy/jiminy-cli/pull/22674)
- feat(config): enable JIT context loading by default by @SandyTao520 in
  [#22736](https://github.com/google-jiminy/jiminy-cli/pull/22736)
- fix(config): ensure discoveryMaxDirs is passed to global config during
  initialization by @kevin-ramdass in
  [#22744](https://github.com/google-jiminy/jiminy-cli/pull/22744)
- fix(plan): allowlist get_internal_docs in Plan Mode by @Adib234 in
  [#22668](https://github.com/google-jiminy/jiminy-cli/pull/22668)
- Changelog for v0.34.0-preview.3 by @jiminy-cli-robot in
  [#22393](https://github.com/google-jiminy/jiminy-cli/pull/22393)
- feat(core): add foundation for subagent tool isolation by @akh64bit in
  [#22708](https://github.com/google-jiminy/jiminy-cli/pull/22708)
- fix(core): handle surrogate pairs in truncateString by @sehoon38 in
  [#22754](https://github.com/google-jiminy/jiminy-cli/pull/22754)
- fix(cli): override j/k navigation in settings dialog to fix search input
  conflict by @sehoon38 in
  [#22800](https://github.com/google-jiminy/jiminy-cli/pull/22800)
- feat(plan): add 'All the above' option to multi-select AskUser questions by
  @Adib234 in [#22365](https://github.com/google-jiminy/jiminy-cli/pull/22365)
- docs: distribute package-specific GEMINI.md context to each package by
  @SandyTao520 in
  [#22734](https://github.com/google-jiminy/jiminy-cli/pull/22734)
- fix(cli): clean up stale pasted placeholder metadata after word/line deletions
  by @Jomak-x in
  [#20375](https://github.com/google-jiminy/jiminy-cli/pull/20375)
- refactor(core): align JIT memory placement with tiered context model by
  @SandyTao520 in
  [#22766](https://github.com/google-jiminy/jiminy-cli/pull/22766)
- Linux sandbox seccomp by @DavidAPierce in
  [#22815](https://github.com/google-jiminy/jiminy-cli/pull/22815)

**Full Changelog**:
https://github.com/google-jiminy/jiminy-cli/compare/v0.34.0-preview.4...v0.35.0-preview.5
