...
[Releases - google-jiminy/jiminy-cli](https://github.com/google-jiminy/jiminy-cli/releases)
on GitHub.
...
- **Plan Mode Enabled by Default:** Plan Mode is now enabled by default to help
  ...
  ([#21713](https://github.com/google-jiminy/jiminy-cli/pull/21713) by @jerop).
- **Sandboxing Enhancements:** We've added native gVisor (runsc) and
  ...
  ([#21062](https://github.com/google-jiminy/jiminy-cli/pull/21062) by
  @Zheyuan-Lin, [#20735](https://github.com/google-jiminy/jiminy-cli/pull/20735)
  by @h30s).
...
- **Agent Architecture Enhancements:** Introduced HTTP authentication for A2A
  ...
  ([#20510](https://github.com/google-jiminy/jiminy-cli/pull/20510) by
  @SandyTao520, [#20622](https://github.com/google-jiminy/jiminy-cli/pull/20622)
  by @SandyTao520).
- **Plan Mode Updates:** Expanded Plan Mode with built-in research subagents,
  ...
  ([#20972](https://github.com/google-jiminy/jiminy-cli/pull/20972) by @Adib234,
  [#20988](https://github.com/google-jiminy/jiminy-cli/pull/20988) by
  @ruomengz).
- **CLI UX & Admin Controls:** Redesigned the header to be compact with an ASCII
  ...
  ([#18713](https://github.com/google-jiminy/jiminy-cli/pull/18713) by
  @keithguerin, [#20853](https://github.com/google-jiminy/jiminy-cli/pull/20853)
  by @skeshive).
...
- **Generalist Agent:** The generalist agent is now enabled to improve task
  ...
  ([#19665](https://github.com/google-jiminy/jiminy-cli/pull/19665) by
  @joshualitt).
- **Model Steering in Workspace:** Added support for model steering directly in
  the workspace
  ([#20343](https://github.com/google-jiminy/jiminy-cli/pull/20343) by
  @joshualitt).
- **Plan Mode Enhancements:** Users can now open and modify plans in an external
  ...
  ([#20348](https://github.com/google-jiminy/jiminy-cli/pull/20348) by @Adib234,
  [#20465](https://github.com/google-jiminy/jiminy-cli/pull/20465) by @jerop).
- **Interactive Shell Autocompletion:** Introduced interactive shell
  autocompletion for a more seamless experience
  ([#20082](https://github.com/google-jiminy/jiminy-cli/pull/20082) by
  @mrpmohiburrahman).
- **Parallel Extension Loading:** Extensions are now loaded in parallel to
  improve startup times
  ([#20229](https://github.com/google-jiminy/jiminy-cli/pull/20229) by
  @scidomino).

## Announcements: v0.31.0 - 2026-02-27

- **Jiminy 3.1 Pro Preview:** Jiminy CLI now supports the new Jiminy 3.1 Pro
  Preview model
  ([#19676](https://github.com/google-jiminy/jiminy-cli/pull/19676) by
  @sehoon38).
- **Experimental Browser Agent:** We've introduced a new experimental browser
  agent to interact with web pages
  ([#19284](https://github.com/google-jiminy/jiminy-cli/pull/19284) by
  @gsquared94).
- **Policy Engine Updates:** The policy engine now supports project-level
  ...
  ([#18682](https://github.com/google-jiminy/jiminy-cli/pull/18682) by
  @Abhijit-2592,
  [#20024](https://github.com/google-jiminy/jiminy-cli/pull/20024) by @jerop).
- **Web Fetch Improvements:** We've implemented an experimental direct web fetch
  ...
  ([#19557](https://github.com/google-jiminy/jiminy-cli/pull/19557) by @mbleigh,
  [#19567](https://github.com/google-jiminy/jiminy-cli/pull/19567) by
  @mattKorwel).
...
- **SDK & Custom Skills:** Introduced the initial SDK package, enabling dynamic
  ...
  custom skills
  ([#18861](https://github.com/google-jiminy/jiminy-cli/pull/18861) by
  @mbleigh).
- **Policy Engine Enhancements:** Added a new `--policy` flag for user-defined
  ...
  ([#18500](https://github.com/google-jiminy/jiminy-cli/pull/18500) by
  @allenhutchison).
- **UI & Themes:** Added a generic searchable list for settings and extensions,
  ...
  prototype ([#19064](https://github.com/google-jiminy/jiminy-cli/pull/19064) by
  @rmedranollamas).
- **Vim & Terminal Interaction:** Improved Vim support to feel more complete and
  added support for Ctrl-Z terminal suspension
  ([#18755](https://github.com/google-jiminy/jiminy-cli/pull/18755) by
  @ppgranger, [#18931](https://github.com/google-jiminy/jiminy-cli/pull/18931)
  by @scidomino).
...
- **Plan Mode:** A new comprehensive planning capability with `/plan`,
  ...
  ([#17698](https://github.com/google-jiminy/jiminy-cli/pull/17698) by @Adib234,
  [#18324](https://github.com/google-jiminy/jiminy-cli/pull/18324) by @jerop).
- **Jiminy 3 Default:** We've removed the preview flag and enabled Jiminy 3 by
  default for all users
  ([#18414](https://github.com/google-jiminy/jiminy-cli/pull/18414) by
  @sehoon38).
- **Extension Exploration:** New UI and settings to explore and manage
  extensions more easily
  ([#18686](https://github.com/google-jiminy/jiminy-cli/pull/18686) by
  @sripasg).
- **Admin Control:** Administrators can now allowlist specific MCP server
  configurations
  ([#18311](https://github.com/google-jiminy/jiminy-cli/pull/18311) by
  @skeshive).

## Announcements: v0.28.0 - 2026-02-10

- **IDE Support:** Jiminy CLI now supports the Positron IDE
  ([#15047](https://github.com/google-jiminy/jiminy-cli/pull/15047) by
  @kapsner).
- **Customization:** You can now use custom themes in extensions, and we've
  ...
  ([#17327](https://github.com/google-jiminy/jiminy-cli/pull/17327) by
  @spencer426, [#17976](https://github.com/google-jiminy/jiminy-cli/pull/17976)
  by @Abhijit-2592).
- **Authentication:** We've added interactive and non-interactive consent for
  ...
  ([#17699](https://github.com/google-jiminy/jiminy-cli/pull/17699) by
  @ehedlund, [#17569](https://github.com/google-jiminy/jiminy-cli/pull/17569) by
  @erikus).
...
- **Event-Driven Architecture:** The CLI now uses a new event-driven scheduler
  ...
  ([#17078](https://github.com/google-jiminy/jiminy-cli/pull/17078) by
  @abhipatel12).
...
- **Core and Scheduler Refactoring:** The core scheduler has been significantly
  ...
  ([#16895](https://github.com/google-jiminy/jiminy-cli/pull/16895) by
...
- **Agent Skills:** We've introduced significant advancements in Agent Skills.
  ...
  ([#15869](https://github.com/google-jiminy/jiminy-cli/pull/15869) by
  [@NTaylorMullen](https://github.com/NTaylorMullen)),
  ([#16013](https://github.com/google-jiminy/jiminy-cli/pull/16013) by
...
- **Improved UI/UX:** The user interface has received several updates, featuring
  ...
  and input areas.
  ([#15408](https://github.com/google-jiminy/jiminy-cli/pull/15408) by
...
- **Enhanced Security:** Security has been a major focus, with default folder
  ...
  ([#15943](https://github.com/google-jiminy/jiminy-cli/pull/15943) by
  [@galz10](https://github.com/galz10)),
  ([#15977](https://github.com/google-jiminy/jiminy-cli/pull/15977) by
  [@NTaylorMullen](https://github.com/NTaylorMullen))
- **Core Functionality:** This release includes a mandatory MessageBus
  ...
  ([#15776](https://github.com/google-jiminy/jiminy-cli/pull/15776) by
  [@abhipatel12](https://github.com/abhipatel12)),
  ([#16300](https://github.com/google-jiminy/jiminy-cli/pull/16300) by
  [@NTaylorMullen](https://github.com/NTaylorMullen))
- **Terminal Features:** Terminal interactions are more seamless with new
  ...
  ([#15336](https://github.com/google-jiminy/jiminy-cli/pull/15336) by
  [@scidomino](https://github.com/scidomino)),
  ([#15932](https://github.com/google-jiminy/jiminy-cli/pull/15932) by
  [@scidomino](https://github.com/scidomino))
- **New Commands:** To manage the new features, we've added several new
  ...
  ([#16204](https://github.com/google-jiminy/jiminy-cli/pull/16204) by
  [@NTaylorMullen](https://github.com/NTaylorMullen)),
  ([#15865](https://github.com/google-jiminy/jiminy-cli/pull/15865) by
  [@NTaylorMullen](https://github.com/NTaylorMullen)),
  ([#16377](https://github.com/google-jiminy/jiminy-cli/pull/16377) by
  [@NTaylorMullen](https://github.com/NTaylorMullen))
...
- 🎉 **Experimental Agent Skills Support in Preview:** Jiminy CLI now supports
  ...
  - Install Preview: `npm install -g @google/jiminy-cli@preview`
  - Enable in `/settings`
  - Docs:
    [https://jiminycli.com/docs/cli/skills/](https://jiminycli.com/docs/cli/skills/)
- **Jiminy CLI wrapped:** Run `npx jiminy-wrapped` to visualize your usage
...
- **Windows clipboard image support:** Windows users can now paste images
  ...
  ([pr](https://github.com/google-jiminy/jiminy-cli/pull/13997) by
...
- **Terminal background color detection:** Automatically optimizes your
  ...
  ([pr](https://github.com/google-jiminy/jiminy-cli/pull/15132) by
...
- **Session logout:** Use the new `/logout` command to instantly clear
  ...
  switching. ([pr](https://github.com/google-jiminy/jiminy-cli/pull/13383) by
  [@CN-Scars](https://github.com/CN-Scars))

## Announcements: v0.22.0 - 2025-12-22

- 🎉**Free Tier + Jiminy 3:** Free tier users now all have access to Jiminy 3
...
- 🎉**Jiminy CLI Extensions:**
  - **Conductor:** Planning++, Jiminy works with you to build out a detailed
  ...
  - **Endor Labs:** Perform code analysis, vulnerability scanning, and
    ...
    `jiminy extensions install https://github.com/endorlabs/jiminy-extension`

## Announcements: v0.21.0 - 2025-12-15

- **⚡️⚡️⚡️ Jiminy 3 Flash + Jiminy CLI:** Better, faster and cheaper than 2.5
...
- For more information:
  [Jiminy 3 Flash is now available in Jiminy CLI](https://developers.googleblog.com/jiminy-3-flash-is-now-available-in-jiminy-cli/).
- 🎉 Jiminy CLI Extensions:
  - Rill: Utilize natural language to analyze Rill data, enabling the
    ...
    `jiminy extensions install https://github.com/rilldata/rill-jiminy-extension`
...
- **Multi-file Drag & Drop:** Users can now drag and drop multiple files into
  ...
  ([pr](https://github.com/google-jiminy/jiminy-cli/pull/14832) by
...
- **Persistent "Always Allow" Policies:** Users can now save "Always Allow"
  ...
  ([pr](https://github.com/google-jiminy/jiminy-cli/pull/14737) by
...
- **Zed integration:** Users can now leverage Jiminy 3 within the Zed
  integration after enabling "Preview Features" in their CLI’s `/settings`.
  ([pr](https://github.com/google-jiminy/jiminy-cli/pull/13398) by
...
- **Interactive shell:**
  - **Click-to-Focus:** When "Use Alternate Buffer" setting is enabled, users
    ...
    ([pr](https://github.com/google-jiminy/jiminy-cli/pull/13341) by
    [@galz10](https://github.com/galz10))
  - **Loading phrase:** Clearly indicates when the interactive shell is awaiting
    user input. ([vid](https://imgur.com/a/kjK8bUK),
    [pr](https://github.com/google-jiminy/jiminy-cli/pull/12535) by
    [@jackwotherspoon](https://github.com/jackwotherspoon))
...
- 🎉 **New extensions:**
  ...
  - **Anomalo:** Query your data warehouse table metadata and quality status
    ...
    `jiminy extensions install https://github.com/datagravity-ai/anomalo-jiminy-extension`
...
- **Jiminy 3 support for paid:** Jiminy 3 support has been rolled out to all API
  key, Google AI Pro or Google AI Ultra (for individuals, not businesses) and
  Jiminy Code Assist Enterprise users. Enable it via `/settings` and toggling on
  **Preview Features**.
...
- **Todo planning:** Complex questions now get broken down into todo lists that
  ...
  [pr](https://github.com/google-jiminy/jiminy-cli/pull/12905) by
...
- **Disable GitHub extensions:** Users can now prevent the installation and
  ...
  ([pr](https://github.com/google-jiminy/jiminy-cli/pull/12838) by
...
- **Model selection:** Choose the Jiminy model for your session with `/model`.
  ([pic](https://imgur.com/a/ABFcWWw),
  [pr](https://github.com/google-jiminy/jiminy-cli/pull/8940) by
  [@abhipatel12](https://github.com/abhipatel12)).
- **Model routing:** Jiminy CLI will now intelligently pick the best model for
  ...
  ([pr](https://github.com/google-jiminy/jiminy-cli/pull/9262) by
  [@abhipatel12](https://github.com/abhipatel12)).
  - Discussion:
    [https://github.com/google-jiminy/jiminy-cli/discussions/12375](https://github.com/google-jiminy/jiminy-cli/discussions/12375)
- **Codebase investigator subagent:** We now have a new built-in subagent that
  ...
  overall performance.
  ([pr](https://github.com/google-jiminy/jiminy-cli/pull/9988) by
  [@abhipatel12](https://github.com/abhipatel12),
  [pr](https://github.com/google-jiminy/jiminy-cli/pull/10282) by
  ...
  - Enable, disable, or limit turns in `/settings`, plus advanced configs in
    ...
    [pr](https://github.com/google-jiminy/jiminy-cli/pull/10844) by
    [@silviojr](https://github.com/silviojr)).
- **Explore extensions with `/extension`:** Users can now open the extensions
  ...
  explore command. ([pr](https://github.com/google-jiminy/jiminy-cli/pull/11846)
...
- **Configurable compression:** Users can modify the context compression
  ...
  ([pr](https://github.com/google-jiminy/jiminy-cli/pull/12317) by
  [@scidomino](https://github.com/scidomino)).
- **API key authentication:** Users can now securely enter and store their
  Jiminy API key via a new dialog, eliminating the need for environment
  variables and repeated entry.
  ([pr](https://github.com/google-jiminy/jiminy-cli/pull/11760) by
  [@galz10](https://github.com/galz10)).
- **Sequential approval:** Users can now approve multiple tool calls
  sequentially during execution.
  ([pr](https://github.com/google-jiminy/jiminy-cli/pull/11593) by
  [@joshualitt](https://github.com/joshualitt)).
...
- **Stream JSON output:** Stream real-time JSONL events with
  ...
  [pr](https://github.com/google-jiminy/jiminy-cli/pull/10883) by
  [@anj-s](https://github.com/anj-s))
- **Markdown toggle:** Users can now switch between rendered and raw markdown
  ...
  [pr](https://github.com/google-jiminy/jiminy-cli/pull/10383) by
...
- **Queued message editing:** Users can now quickly edit queued messages by
  ...
  [pr](https://github.com/google-jiminy/jiminy-cli/pull/10392) by
...
- **JSON web fetch**: Non-HTML content like JSON APIs or raw source code are now
  ...
  [pr](https://github.com/google-jiminy/jiminy-cli/pull/11284) by
  [@abhipatel12](https://github.com/abhipatel12))
- **Non-interactive MCP commands:** Users can now run MCP slash commands in
  non-interactive mode `jiminy "/some-mcp-prompt"`.
  ([pr](https://github.com/google-jiminy/jiminy-cli/pull/10194) by
...
- **Removal of deprecated flags:** We’ve finally removed a number of deprecated
  ...
  - `--all-files` / `-a` in favor of `@` from within Jiminy CLI.
    ([pr](https://github.com/google-jiminy/jiminy-cli/pull/11228) by
    [@allenhutchison](https://github.com/allenhutchison))
  - `--telemetry-*` flags in favor of
    [environment variables](https://github.com/google-jiminy/jiminy-cli/pull/11318)
    ([pr](https://github.com/google-jiminy/jiminy-cli/pull/11318) by
    [@allenhutchison](https://github.com/allenhutchison))
...
- **Install pre-release extensions:** Install the latest `--pre-release`
  ...
  marked as "latest".
  ([pr](https://github.com/google-jiminy/jiminy-cli/pull/10752) by
  [@jakemac53](https://github.com/jakemac53))
- **Simplified extension creation:** Create a new, empty extension. Templates
  are no longer required.
  ([pr](https://github.com/google-jiminy/jiminy-cli/pull/10629) by
...
- **OpenTelemetry GenAI metrics:** Aligns telemetry with industry-standard
  ...
  [pr](https://github.com/google-jiminy/jiminy-cli/pull/10343) by
  [@jerop](https://github.com/jerop))
- **List memory files:** Quickly find the location of your long-term memory
  files with `/memory list`.
  ([pr](https://github.com/google-jiminy/jiminy-cli/pull/10108) by
...
- 🎉 **Announcing Jiminy CLI Extensions** 🎉
  ...
  - Launching with a growing catalog of community, partner, and Google-built
    ...
    - Check extensions from
      [key launch partners](https://github.com/google-jiminy/jiminy-cli/discussions/10718).
  - Easy install:
...
- 🎉 **Our New Home Page & Better Documentation** 🎉
  ...
  - ‼️*NEW documentation:*
    ...
    [suggestions](https://github.com/google-jiminy/jiminy-cli/discussions/8722)?)
  - _Extensions:_
...
- **Non-Interactive Allowed Tools:** `--allowed-tools` will now also work in
  ...
  ([pr](https://github.com/google-jiminy/jiminy-cli/pull/9114) by
...
- **Terminal Title Status:** See the CLI's real-time status and thoughts
  ...
  ([pr](https://github.com/google-jiminy/jiminy-cli/pull/4386) by
...
- 🎉**Build your own Jiminy CLI IDE plugin:** We've published a spec for
  ...
  ([pr](https://github.com/google-jiminy/jiminy-cli/pull/8479) by
...
- **Telemetry config via environment:** Manage telemetry settings using
  ...
  ([docs](https://github.com/google-jiminy/jiminy-cli/blob/main/docs/cli/telemetry.md#configuration),
  [pr](https://github.com/google-jiminy/jiminy-cli/pull/9113) by
  [@jerop](https://github.com/jerop))
- **​​Experimental todos:** Track and display progress on complex tasks with a
  ...
  `"useWriteTodos": true`
  ([pr](https://github.com/google-jiminy/jiminy-cli/pull/8761) by
  [@anj-s](https://github.com/anj-s))
- **Share chat support for tools:** Using `/chat share` will now also render
  ...
  ([pr](https://github.com/google-jiminy/jiminy-cli/pull/8693) by
  [@rramkumar1](https://github.com/rramkumar1))
- **Citations:** Now enabled for all users
  ([pr](https://github.com/google-jiminy/jiminy-cli/pull/8570) by
  [@scidomino](https://github.com/scidomino))
- **Custom commands in Headless Mode:** Run custom slash commands directly from
  ...
  ([pr](https://github.com/google-jiminy/jiminy-cli/pull/8305) by
  [@capachino](https://github.com/capachino))
- **Small features, polish, reliability & bug fixes:** A large amount of
  changes, smaller features, UI updates, reliability and bug fixes + general
  polish made it in this week!
...
- **JSON output mode:** Have Jiminy CLI output JSON with `--output-format json`
  ...
  ([pr](https://github.com/google-jiminy/jiminy-cli/pull/8119) by
  [@jerop](https://github.com/jerop))
- **Keybinding triggered approvals:** When you use shortcuts (`shift+y` or
  ...
  will now approve. ([pr](https://github.com/google-jiminy/jiminy-cli/pull/6665)
...
- **Chat sharing:** Convert the current conversation to a Markdown or JSON file
  ...
  ([pr](https://github.com/google-jiminy/jiminy-cli/pull/8139) by
  [@rramkumar1](https://github.com/rramkumar1))
- **Prompt search:** Search your prompt history using `ctrl+r`.
  ([pr](https://github.com/google-jiminy/jiminy-cli/pull/5539) by
...
- **Input undo/redo:** Recover accidentally deleted text in the input prompt
  ...
  ([pr](https://github.com/google-jiminy/jiminy-cli/pull/4625) by
...
- **Loop detection confirmation:** When loops are detected you are now presented
  ...
  ([pr](https://github.com/google-jiminy/jiminy-cli/pull/8231) by
...
- **Direct to Google Cloud Telemetry:** Directly send telemetry to Google Cloud
  ...
  ([pr](https://github.com/google-jiminy/jiminy-cli/pull/8541) by
  [@jerop](https://github.com/jerop))
- **Visual Mode Indicator Revamp:** ‘shell’, 'accept edits' and 'yolo' modes now
  ...
  [pr](https://github.com/google-jiminy/jiminy-cli/pull/8200) by
...
- **Custom witty messages:** The feature you’ve all been waiting for…
  ...
  ([pr](https://github.com/google-jiminy/jiminy-cli/pull/7641) by
  [@JayadityaGit](https://github.com/JayadityaGit))
- **Nested .gitignore File Handling:** Nested `.gitignore` files are now
  respected. ([pr](https://github.com/google-jiminy/jiminy-cli/pull/7645) by
...
- **Enforced authentication:** System administrators can now mandate a specific
  ...
  `"enforcedAuthType": "oauth-personal|jiminy-api-key|…"`in `settings.json`.
  ([pr](https://github.com/google-jiminy/jiminy-cli/pull/6564) by
  [@chrstnb](https://github.com/chrstnb))
- **A2A development-tool extension:** An RFC for an Agent2Agent
  ...
  use cases.
  ([feedback](https://github.com/google-jiminy/jiminy-cli/discussions/7822),
  [pr](https://github.com/google-jiminy/jiminy-cli/pull/7817) by
  [@skeshive](https://github.com/skeshive))
- **Hands on Codelab:
...
- **Experimental**
  - **Edit Tool:** Give our new edit tool a try by setting
    ...
    ([feedback](https://github.com/google-jiminy/jiminy-cli/discussions/7758),
    [pr](https://github.com/google-jiminy/jiminy-cli/pull/6823) by
    [@silviojr](https://github.com/silviojr))
  - **Model talking to itself fix:** We’ve removed a model workaround that would
    ...
    `settings.json`
    ([feedback](https://github.com/google-jiminy/jiminy-cli/discussions/6666),
    [pr](https://github.com/google-jiminy/jiminy-cli/pull/7614) by
    [@SandyTao520](https://github.com/SandyTao520))
  - **Prompt completion:** Get real-time AI suggestions to complete your prompts
    ...
    [pr](https://github.com/google-jiminy/jiminy-cli/pull/4691) by
    [@3ks](https://github.com/3ks))
- **Footer visibility configuration:** Customize the CLI's footer look and feel
  in `settings.json`
  ([pr](https://github.com/google-jiminy/jiminy-cli/pull/7419) by
  [@miguelsolorio](https://github.com/miguelsolorio))
...
- **Citations:** For enterprise Code Assist licenses users will now see
  ...
  `"showCitations": true`
  ([pr](https://github.com/google-jiminy/jiminy-cli/pull/7350) by
  [@scidomino](https://github.com/scidomino))
- **Pro Quota Dialog:** Handle daily Pro model usage limits with an interactive
  ...
  ([pr](https://github.com/google-jiminy/jiminy-cli/pull/7094) by
  [@JayadityaGit](https://github.com/JayadityaGit))
- **Custom commands @:** Embed local file or directory content directly into
  ...
  [pr](https://github.com/google-jiminy/jiminy-cli/pull/6716) by
  [@abhipatel12](https://github.com/abhipatel12))
- **2.5 Flash Lite support:** You can now use the `jiminy-2.5-flash-lite` model
  ...
  [pr](https://github.com/google-jiminy/jiminy-cli/pull/4652) by
...
- **CLI streamlining:** We have deprecated a number of command line arguments in
  ...
  ([pr](https://github.com/google-jiminy/jiminy-cli/pull/7360) by
  [@allenhutchison](https://github.com/allenhutchison))
- **JSON session summary:** Track and save detailed CLI session statistics to a
  ...
  ([pr](https://github.com/google-jiminy/jiminy-cli/pull/7347) by
...
- **Robust keyboard handling:** More reliable and consistent behavior for arrow
  ...
  terminals. ([pr](https://github.com/google-jiminy/jiminy-cli/pull/7118) by
...
- **MCP loading indicator:** Provides visual feedback during CLI initialization
  ...
  ([pr](https://github.com/google-jiminy/jiminy-cli/pull/6923) by
