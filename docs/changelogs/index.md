...
[Releases - Plaer1/jiminy-cli](https://github.com/Plaer1/jiminy-cli/releases) on
GitHub.
...
- **Sandboxing Enhancements:** We've added native gVisor (runsc) and
  ...
  ([#21062](https://github.com/Plaer1/jiminy-cli/pull/21062) by @Zheyuan-Lin,
  [#20735](https://github.com/Plaer1/jiminy-cli/pull/20735) by @h30s).
...
- **Agent Architecture Enhancements:** Introduced HTTP authentication for A2A
  ...
  ([#20510](https://github.com/Plaer1/jiminy-cli/pull/20510) by @SandyTao520,
  [#20622](https://github.com/Plaer1/jiminy-cli/pull/20622) by @SandyTao520).
- **Plan Mode Updates:** Expanded Plan Mode with built-in research subagents,
  ...
  [#20988](https://github.com/Plaer1/jiminy-cli/pull/20988) by @ruomengz).
- **CLI UX & Admin Controls:** Redesigned the header to be compact with an ASCII
  ...
  ([#18713](https://github.com/Plaer1/jiminy-cli/pull/18713) by @keithguerin,
  [#20853](https://github.com/Plaer1/jiminy-cli/pull/20853) by @skeshive).

## Announcements: v0.32.0 - 2026-03-03

- **Generalist Agent:** The generalist agent is now enabled to improve task
  delegation and routing
  ([#19665](https://github.com/Plaer1/jiminy-cli/pull/19665) by @joshualitt).
- **Model Steering in Workspace:** Added support for model steering directly in
  the workspace ([#20343](https://github.com/Plaer1/jiminy-cli/pull/20343) by
  @joshualitt).
...
- **Policy Engine Updates:** The policy engine now supports project-level
  ...
  ([#18682](https://github.com/Plaer1/jiminy-cli/pull/18682) by @Abhijit-2592,
...
- **Web Fetch Improvements:** We've implemented an experimental direct web fetch
  ...
  [#19567](https://github.com/Plaer1/jiminy-cli/pull/19567) by @mattKorwel).
...
- **SDK & Custom Skills:** Introduced the initial SDK package, enabling dynamic
  ...
  custom skills ([#18861](https://github.com/Plaer1/jiminy-cli/pull/18861) by
  @mbleigh).
...
- **Vim & Terminal Interaction:** Improved Vim support to feel more complete and
  ...
  ([#18755](https://github.com/Plaer1/jiminy-cli/pull/18755) by @ppgranger,
  [#18931](https://github.com/Plaer1/jiminy-cli/pull/18931) by @scidomino).
...
- **Jiminy 3 Default:** We've removed the preview flag and enabled Jiminy 3 by
  ...
  ([#18414](https://github.com/Plaer1/jiminy-cli/pull/18414) by @sehoon38).
- **Extension Exploration:** New UI and settings to explore and manage
  extensions more easily
  ([#18686](https://github.com/Plaer1/jiminy-cli/pull/18686) by @sripasg).
- **Admin Control:** Administrators can now allowlist specific MCP server
  configurations ([#18311](https://github.com/Plaer1/jiminy-cli/pull/18311) by
  @skeshive).

## Announcements: v0.28.0 - 2026-02-10

- **IDE Support:** Jiminy CLI now supports the Positron IDE
  ([#15047](https://github.com/Plaer1/jiminy-cli/pull/15047) by @kapsner).
- **Customization:** You can now use custom themes in extensions, and we've
  ...
  ([#17327](https://github.com/Plaer1/jiminy-cli/pull/17327) by @spencer426,
  [#17976](https://github.com/Plaer1/jiminy-cli/pull/17976) by @Abhijit-2592).
- **Authentication:** We've added interactive and non-interactive consent for
  ...
  ([#17699](https://github.com/Plaer1/jiminy-cli/pull/17699) by @ehedlund,
  [#17569](https://github.com/Plaer1/jiminy-cli/pull/17569) by @erikus).
...
- **Event-Driven Architecture:** The CLI now uses a new event-driven scheduler
  ...
  ([#17078](https://github.com/Plaer1/jiminy-cli/pull/17078) by @abhipatel12).
...
- **New `/rewind` Command:** Easily navigate your session history with the new
  `/rewind` command ([#15720](https://github.com/Plaer1/jiminy-cli/pull/15720)
  by @Adib234).
...
- **Agents and Skills:** We've introduced a new `skill-creator` skill
  ([#16394](https://github.com/Plaer1/jiminy-cli/pull/16394) by @NTaylorMullen),
  enabled agent skills by default, and added a generalist agent to improve task
  routing ([#16638](https://github.com/Plaer1/jiminy-cli/pull/16638) by
  @joshualitt).
- **UI/UX Improvements:** You can now "Rewind" through your conversation history
  ([#15717](https://github.com/Plaer1/jiminy-cli/pull/15717) by @Adib234).
- **Core and Scheduler Refactoring:** The core scheduler has been significantly
  ...
  ([#16895](https://github.com/Plaer1/jiminy-cli/pull/16895) by @abhipatel12),
...
- **Core Functionality & Performance:** This release includes support for
  ...
  instructions ([#16139](https://github.com/Plaer1/jiminy-cli/pull/16139) by
...
- **Improved UI/UX:** The user interface has received several updates, featuring
  ...
  and input areas. ([#15408](https://github.com/Plaer1/jiminy-cli/pull/15408) by
...
- **Terminal background color detection:** Automatically optimizes your
  ...
  accessibility warnings. ([pr](https://github.com/Plaer1/jiminy-cli/pull/15132)
...
- **Codebase investigator subagent:** We now have a new built-in subagent that
  ...
  overall performance. ([pr](https://github.com/Plaer1/jiminy-cli/pull/9988) by
  [@abhipatel12](https://github.com/abhipatel12),
...
- **Explore extensions with `/extension`:** Users can now open the extensions
  ...
  explore command. ([pr](https://github.com/Plaer1/jiminy-cli/pull/11846) by
  [@JayadityaGit](https://github.com/JayadityaGit)).
...
- **Install pre-release extensions:** Install the latest `--pre-release`
  ...
  marked as "latest". ([pr](https://github.com/Plaer1/jiminy-cli/pull/10752) by
  [@jakemac53](https://github.com/jakemac53))
- **Simplified extension creation:** Create a new, empty extension. Templates
  are no longer required. ([pr](https://github.com/Plaer1/jiminy-cli/pull/10629)
...
- **Non-Interactive Allowed Tools:** `--allowed-tools` will now also work in
  non-interactive mode. ([pr](https://github.com/Plaer1/jiminy-cli/pull/9114) by
...
- **​​Experimental todos:** Track and display progress on complex tasks with a
  ...
  `"useWriteTodos": true` ([pr](https://github.com/Plaer1/jiminy-cli/pull/8761)
...
- **Keybinding triggered approvals:** When you use shortcuts (`shift+y` or
  ...
  will now approve. ([pr](https://github.com/Plaer1/jiminy-cli/pull/6665) by
...
- **Edit Tool improvements:** Jiminy CLI’s ability to edit files should now be
  far more capable. ([pr](https://github.com/Plaer1/jiminy-cli/pull/7679) by
  [@silviojr](https://github.com/silviojr))
...
- **A2A development-tool extension:** An RFC for an Agent2Agent
  ...
  use cases. ([feedback](https://github.com/Plaer1/jiminy-cli/discussions/7822),
...
- **Footer visibility configuration:** Customize the CLI's footer look and feel
  in `settings.json` ([pr](https://github.com/Plaer1/jiminy-cli/pull/7419) by
  [@miguelsolorio](https://github.com/miguelsolorio))
...
- **Citations:** For enterprise Code Assist licenses users will now see
  ...
  `"showCitations": true` ([pr](https://github.com/Plaer1/jiminy-cli/pull/7350)
