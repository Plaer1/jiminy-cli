...
The `activate_skill` tool lets Jiminy CLI load specialized procedural expertise
...
tasks, such as reviewing code or creating pull requests. Jiminy CLI uses this
...
The `activate_skill` tool is used exclusively by the Jiminy agent. You cannot
