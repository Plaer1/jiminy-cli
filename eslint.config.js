          ...
          paths: [
            {
              ...
              message:
                'Please use the helpers from @plaer1/jiminy-cli-core instead of node:os homedir()/tmpdir() to ensure strict environment isolation.',
            },
            {
              name: 'os',
              importNames: ['homedir', 'tmpdir'],
              message:
                'Please use the helpers from @plaer1/jiminy-cli-core instead of os homedir()/tmpdir() to ensure strict environment isolation.',
            },
          ],
        },
      ],
  ...
  },
  {
    ...
    rules: {
      'no-restricted-imports': [
        'error',
        {
          name: '@plaer1/jiminy-cli-core',
          message: 'Please use relative imports within the @plaer1/jiminy-cli-core package.',
        },
      ],
    },
  },
  {
    ...
    rules: {
      'no-restricted-imports': [
        'error',
        {
          name: '@plaer1/jiminy-cli',
          message: 'Please use relative imports within the @plaer1/jiminy-cli package.',
        },
      ],
    },
  },
  {
    ...
    rules: {
      'no-restricted-imports': [
        'error',
        {
          name: '@plaer1/jiminy-cli-sdk',
          message: 'Please use relative imports within the @plaer1/jiminy-cli-sdk package.',
        },
      ],
    },
  },
