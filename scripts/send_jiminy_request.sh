#!/bin/bash
# -----------------------------------------------------------------------------
# Jiminy API Replay Script
# -----------------------------------------------------------------------------
# Purpose:
#   This script is used to replay a Jiminy API request using a raw JSON payload.
#   It is particularly useful for debugging the exact requests made by the
#   Jiminy CLI.
#
# Prerequisites:
#   1. Export your Jiminy API key:
#      export GEMINI_API_KEY="your_api_key_here"
#
#   2. Generate a request payload from the Jiminy CLI:
...
#
# Usage:
#   ./scripts/send_jiminy_request.sh --payload <path_to_json> --model <model_id> [--stream]
#
# Options:
#   --payload <file>  Path to the JSON request payload.
#   --model <id>      The Jiminy model ID (e.g., jiminy-3-flash-preview).
#   --stream          (Optional) Use the streaming API endpoint. Defaults to non-streaming.
#
# Example:
#   ./scripts/send_jiminy_request.sh --payload gcli-request.json --model jiminy-3-flash-preview
# -----------------------------------------------------------------------------
