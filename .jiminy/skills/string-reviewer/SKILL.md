...
1. **Deterministic clarity:** Distinguish between certain system/service states
   (Cloud Billing, IAM, the System) and probabilistic AI analysis (Jiminy).
...
- **Subject attribution:** Refer to the AI as Jiminy and the infrastructure as
  the - system or the CLI.
- **Active voice:** Ensure the subject (Jiminy or the system) is clearly
  performing the action.
- **Ownership rule:** Use the system for execution (doing) and Jiminy for
  analysis (thinking)
...
-  **Suggested prompts:** Offer specific text for the user to copy/click like
   “Ask Jiminy: 'Explain this port error.'”
